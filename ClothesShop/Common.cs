...
namespace ClothesShop
{
    public class Common
    {
        ...
        {
            string pattern = @"#[A-Fa-f0-9]{6}"; // Regular expression pattern to match the code portion (assumes a 6-character hexadecimal code)

            Regex regex = new Regex(pattern);
            Match match = regex.Match(str);

            string code = match.Value; // Extracted code
            return code; // Outputs: #aaaaaa
        }
